...
MODEL                = rpend_devdriv
MODULES              = rt_matrx.c rt_printf.c rt_logging.c rpend_devdriv_data.c rtGetInf.c rtGetNaN.c rt_nonfinite.c
MAKEFILE             = rpend_devdriv.mk
...
MASTER_ANCHOR_DIR    = 
START_DIR            = E:\MATLAB_WORK\LaboratoriumProblemowe\CZW16452024\repo\skrypty
...
MODELLIB                  = rpend_devdrivlib.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = rpend_devdriv_ref.rsp
MODELREF_INC_PATH         = 
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\rpend_devdriv_RTCON
MATLAB_INCLUDES = $(MATLAB_INCLUDES);E:\MATLAB_WORK\LaboratoriumProblemowe\CZW16452024
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(MATLAB_ROOT)\extern\include
